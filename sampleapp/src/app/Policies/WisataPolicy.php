...
class WisataPolicy
{
    ...
    {
        return $user->can('view_any_wisata');
    }
    ...
    {
        return $user->can('delete_any_wisata');
    }
     ...
     */
    public function replicate(User $user, Wisata $wisata): bool
    {
